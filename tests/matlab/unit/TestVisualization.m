...
%   Tests the tracking.viz.Visualizer class methods.
    ...
    methods (Test)
        ...
        function testCreateFigure(testCase)
            fig = tracking.viz.Visualizer.createFigure('Test', 800, 600);
        ...
        function testColorPalette(testCase)
            colors = tracking.viz.Visualizer.COLORS;
        ...
        function testPlotDbtTrajectory(testCase)
            ...
            fig = tracking.viz.Visualizer.createFigure('Test', 600, 400);
            tracking.viz.Visualizer.plotDbtTrajectory(truthX, meas, estimates, labels);
        ...
        function testPlotRmseComparison(testCase)
            ...
            fig = tracking.viz.Visualizer.createFigure('Test', 600, 400);
            tracking.viz.Visualizer.plotRmseComparison(rmseData, labels, 'Test RMSE');
        ...
        function testPlotRmseBarChart(testCase)
            ...
            fig = tracking.viz.Visualizer.createFigure('Test', 600, 400);
            tracking.viz.Visualizer.plotRmseBarChart(meanRmse, labels, groups, 'Test');
        ...
        function testPlotHeatmap(testCase)
            ...
            fig = tracking.viz.Visualizer.createFigure('Test', 600, 400);
            tracking.viz.Visualizer.plotHeatmap(data, 'X', 'Y', 'Test Heatmap');
        ...
        function testPlotTimingComparison(testCase)
            ...
            fig = tracking.viz.Visualizer.createFigure('Test', 600, 400);
            tracking.viz.Visualizer.plotTimingComparison(timingData, labels);
