...
%   using the unified MotionModelConfig and MotionModelEKF interfaces.
    ...
    methods (TestMethodSetup)
        ...
        function setupConfigs(obj)
            ...
            obj.configCV = tracking.single.dbt.MotionModelConfig('CV', 'numSteps', obj.numSteps, 'dt', obj.dt);
            obj.configCA = tracking.single.dbt.MotionModelConfig('CA', 'numSteps', obj.numSteps, 'dt', obj.dt);
            obj.configCT = tracking.single.dbt.MotionModelConfig('CT', 'numSteps', obj.numSteps, 'dt', obj.dt);
            obj.configSinger = tracking.single.dbt.MotionModelConfig('Singer', 'numSteps', obj.numSteps, 'dt', obj.dt);
            obj.configCS = tracking.single.dbt.MotionModelConfig('CS', 'numSteps', obj.numSteps, 'dt', obj.dt);
            obj.configIMM = tracking.single.dbt.ConfigIMM('numSteps', obj.numSteps, 'dt', obj.dt);
            obj.configManeuver = tracking.single.dbt.ConfigManeuver('numSteps', obj.numSteps, 'dt', obj.dt);
        end
    end
    ...
    methods (Test)
        ...
        function testUnifiedCVFilterCreation(obj)
            ekf = tracking.single.dbt.MotionModelEKF(obj.configCV);
        ...
        function testUnifiedCVFilterRun(obj)
            ekf = tracking.single.dbt.MotionModelEKF(obj.configCV);
            scenario = tracking.single.dbt.ScenarioManeuver(obj.configManeuver);
        ...
        function testUnifiedCAFilterCreation(obj)
            ekf = tracking.single.dbt.MotionModelEKF(obj.configCA);
        ...
        function testUnifiedCTFilterCreation(obj)
            ekf = tracking.single.dbt.MotionModelEKF(obj.configCT);
        ...
        function testUnifiedSingerFilterCreation(obj)
            ekf = tracking.single.dbt.MotionModelEKF(obj.configSinger);
        ...
        function testUnifiedCSFilterCreation(obj)
            ekf = tracking.single.dbt.MotionModelEKF(obj.configCS);
        ...
        function testIMMFilterCreation(obj)
            imm = tracking.single.dbt.IMM(obj.configIMM);
