...
%
%   See also: tracking.multi.rfs.phd.ImmPhdFilter, tracking.multi.rfs.phd.SimmUtils, tracking.multi.rfs.phd.Config
    ...
    methods
        ...
        %       est - Estimation results structure
            ...
            for k = 1:K
                [w0, m0, P0, cNorm] = tracking.multi.rfs.phd.SimmUtils.inputInteraction(...
                ...
                obj.miu = tracking.multi.rfs.phd.SimmUtils.updateProbability(k, obj.model, obj.est, cNorm, obj.miu);

                [wUpdate, mUpdate, PUpdate, LUpdate] = ...
                    tracking.multi.rfs.phd.SimmUtils.outputInteraction(k, obj.model, obj.est, obj.miu);
