...
%
%   See also: tracking.multi.rfs.phd.Config, tracking.multi.rfs.phd.MultiModelFilter
        ...
        % GENNEWSTATE  Generic state transition function.
            ...
            if isequal(B, obj.model.G_CV)
                ...
                if isempty(Xd)
                    ...
                    X = tracking.multi.rfs.phd.MathUtils.expandState4to6(x4new);
                end
            ...
            elseif isequal(B, obj.model.G_CT)
                ...
                if isempty(Xd)
                    ...
                    x4ct = x5new([1,2,3,4], :);
                    X = tracking.multi.rfs.phd.MathUtils.expandState4to6(x4ct);
                end
