...
%
%   See also: tracking.multi.rfs.phd.MultiModelFilter, tracking.multi.rfs.phd.Config
    ...
    methods (Static)
        ...
        %       w, x, P - Managed Gaussian mixture parameters
            ...
            [w, x, P] = tracking.multi.rfs.phd.GaussMixture.prune(w, x, P, elimThresh);
            [w, x, P] = tracking.multi.rfs.phd.GaussMixture.merge(w, x, P, mergeThresh);
            [w, x, P] = tracking.multi.rfs.phd.GaussMixture.cap(w, x, P, maxNum);
        end
        ...
        %       threshInfo  - Struct with computed thresholds (for debugging)
            ...
            [elimThresh, mergeThresh, maxNum] = tracking.multi.rfs.phd.GaussMixture.computeAdaptiveThresholds(...
