...
%
%   Usage:
%       model = tracking.multi.rfs.phd.Config();           % Default configuration
%       model = tracking.multi.rfs.phd.Config('T', 0.5);   % Custom sampling period
%
%   See also: tracking.multi.rfs.phd.Scenario, tracking.multi.rfs.phd.MultiModelFilter
