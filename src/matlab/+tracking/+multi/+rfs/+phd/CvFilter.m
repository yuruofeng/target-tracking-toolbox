...
%
%   See also: tracking.multi.rfs.phd.CtFilter, tracking.multi.rfs.phd.CaFilter, tracking.multi.rfs.phd.MultiModelFilter
    ...
    methods (Static)
        ...
        %       PPred - 4D predicted covariance [4 x 4 x nComps]
            ...
            nComps = size(m, 2);
            [m4, P4] = tracking.multi.rfs.phd.MathUtils.reduceState6to4(m, P);
        ...
        %       PUpdate  - Updated covariance [4 x 4 x nComps]
            ...
            for ii = 1:nComps
                [qz, mT, PT] = tracking.multi.rfs.phd.CvFilter.kalmanUpdateSingle(...
        ...
        %       lk - Scalar likelihood value
            ...
            lk = tracking.multi.rfs.phd.CvFilter.computeWeightedLikelihood(...
        ...
        %       zGate - Gated measurement matrix
            ...
            zGate = tracking.multi.rfs.phd.CvFilter.ellipsoidalGate(...
    ...
    methods (Static, Access = private)
        ...
        % ELLIPSOIDALGATE  Ellipsoidal gating based on Mahalanobis distance.
            ...
            for jj = 1:nComps
                Sj = R + H * P(:, :, jj) * H';
                Sj = (Sj + Sj') / 2;
                Sj = tracking.multi.rfs.phd.MathUtils.ensurePositiveDefinite(Sj, 1e-6);
