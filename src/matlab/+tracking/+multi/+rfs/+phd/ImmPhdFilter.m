...
%
%   See also: tracking.multi.rfs.phd.SimmPhdFilter, tracking.multi.rfs.phd.MultiModelFilter, tracking.multi.rfs.phd.Config
    ...
    methods
        ...
        %
        %   Inputs:
        %       model       - tracking.multi.rfs.phd.Config configuration object
        ...
        %       est - Estimation results structure
            ...
            for k = 1:K
                [w0, m0, P0, cNorm] = tracking.multi.rfs.phd.ImmUtils.inputInteraction(...
                    k, obj.model, obj.est, wUpdate, mUpdate, PUpdate, LUpdate, obj.miu);
                nGMs = length(w0{1});
                L0 = {nGMs; nGMs; nGMs};

                [w1,m1,P1,L1,lk1, w2,m2,P2,L2,lk2, w3,m3,P3,L3,lk3] = ...
                    tracking.multi.rfs.phd.MultiModelFilter.run(k, obj.model, meas, obj.config, w0, m0, P0, L0);
                ...
                obj.miu = tracking.multi.rfs.phd.ImmUtils.updateProbability(k, obj.model, obj.est, cNorm, obj.miu);

                [wUpdate, mUpdate, PUpdate, LUpdate] = ...
                    tracking.multi.rfs.phd.ImmUtils.outputInteraction(k, obj.model, obj.est, obj.miu);
                ...
                if obj.config.useAdaptive
                    ...
                    [wUpdate, mUpdate, PUpdate] = tracking.multi.rfs.phd.GaussMixture.adaptiveManage(...
                        wUpdate, mUpdate, PUpdate, gmConfig);
                else
                    [wUpdate, mUpdate, PUpdate] = tracking.multi.rfs.phd.GaussMixture.manage(wUpdate, mUpdate, PUpdate, ...
