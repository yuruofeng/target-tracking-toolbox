classdef (Abstract) KalmanFilterBase < tracking.single.dbt.BaseFilter
...
%
%   See also: tracking.single.dbt.BaseFilter, tracking.single.dbt.EKF, tracking.single.dbt.UKF, tracking.single.dbt.CKF
    ...
    methods (Access = protected)
        ...
        % WRAPANGLEINNOVATION  Wrap angle innovation to [-pi, pi].
            ...
            innov(angleIdx) = tracking.core.FilterUtils.wrapToPi(innov(angleIdx));
        end
