...
%       cfg = tracking.single.dbt.MotionModelConfig('CA', 'dt', 0.5);
    ...
    methods
        ...
        % GETSTATETRANSITIONMATRIX  Get state transition matrix.
            ...
            switch obj.modelType
                ...
                case 'CT'
                    F = tracking.models.MeasurementModel.ctDynamicMatrix(T, state);
        ...
        % GETMEASUREMENTJACOBIAN  Get measurement Jacobian matrix.
            switch obj.modelType
                ...
                case 'CT'
                    H = tracking.models.MeasurementModel.ctMeasJacobian(state);
        ...
        % MEASUREMENTFUNCTION  Compute predicted measurement.
            switch obj.modelType
                ...
                case 'CT'
                    z = tracking.models.MeasurementModel.ctMeasFunc(state);
                otherwise
                    z = [];
            end
        end
