...
%
%   Usage:
%       cfg = tracking.single.tbd.Config();           % Default configuration (CV model)
%       cfg = tracking.single.tbd.Config('motionModel', 'CA');  % Constant Acceleration
%       cfg = tracking.single.tbd.Config('numFrames', 100, 'gridSize', [200, 200]);
