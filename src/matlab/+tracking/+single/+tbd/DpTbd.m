classdef DpTbd < tracking.single.tbd.BaseTbd
...
%
%   使用方法：
%       cfg = tracking.single.tbd.Config();                           % 创建配置
%       dp = tracking.single.tbd.DpTbd(cfg);                          % 创建DP-TBD
...
%
%   See also: tracking.single.tbd.BaseTbd, tracking.single.tbd.PfTbd, tracking.single.tbd.Scenario
