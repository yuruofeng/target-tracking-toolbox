classdef PfTbd < tracking.single.tbd.BaseTbd
...
%
%   See also: tracking.single.tbd.BaseTbd, tracking.single.tbd.DpTbd, tracking.single.tbd.Scenario
    ...
    methods
        ...
        %
        %   输入参数：
        %       cfg - (可选) tracking.single.tbd.Config配置对象
            obj@tracking.single.tbd.BaseTbd(cfg);
        end
        ...
        % RESAMPLE  系统重采样与对数和指数归一化。
            ...
            nP = obj.config.numParticles;
            idx = tracking.core.FilterUtils.systematicResample(w, nP);
