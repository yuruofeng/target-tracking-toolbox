classdef Constants
    ...
    %
    %   使用示例:
    %       pD = tracking.extended.utils.Constants.DEFAULT_DETECTION_PROBABILITY;
    %       dim = tracking.extended.utils.Constants.SPATIAL_DIMENSION;
    ...
    methods (Static)
        function idx = getPIndexMatrix(s, d)
            ...
            %   idx = tracking.extended.utils.Constants.getPIndexMatrix(s, d)
            %
            %   输入参数:
            %       s - 运动模型阶数 (double)
            %       d - 空间维度 (double)
        ...
        function R = getIdentityMatrix(d)
            ...
            %   R = tracking.extended.utils.Constants.getIdentityMatrix(d)
            %
            %   输入参数:
            %       d - 维度 (double)
            %
        ...
        function vol = calculateVolume(xMin, xMax, yMin, yMax)
            ...
            %   vol = tracking.extended.utils.Constants.calculateVolume(xMin, xMax, yMin, yMax)
            %
            %   输入参数:
