...
%
%   See also: tracking.single.dbt.UKF, tracking.single.dbt.CKF, tracking.single.dbt.ParticleFilter
    ...
    methods (Static)
        ...
        %       sigmaPts - [n x 2n+1] sigma点矩阵
            ...
            sqrtP  = tracking.core.FilterUtils.cholPsd(P * (n + lambda));
        ...
        %       cubPts  - [n x 2n] 容积点矩阵
            ...
            sqP = tracking.core.FilterUtils.cholPsd(P);
